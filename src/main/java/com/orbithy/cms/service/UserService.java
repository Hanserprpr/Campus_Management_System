...
public class UserService {
    ...
    public ResponseEntity<Result> getStudentList(String userId,Integer grade, String major, Integer status, Integer pageNum, Integer pageSize) {
        try {
            // 验证管理员权限
            if (userMapper.getPermissionById(userId) != 0) {
                return ResponseUtil.build(Result.error(403, "无权限访问"));
            }
